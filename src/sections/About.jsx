...
const About = () => {
  ...
  const marqueeLogos = [
    ...
    { src: '/assets/django.png', alt: 'Django' },
    { src: '/assets/js.png', alt: 'JS' },
    { src: '/assets/Tailwind.png', alt: 'Tailwind' },
    { src: '/assets/post.png', alt: 'Postgres' },
    { src: '/assets/download.png', alt: 'Figma' },
    { src: '/assets/spring.png', alt: 'Spring' },
    { src: '/assets/github.png', alt: 'Github' },
    { src: '/assets/git.jpg', alt: 'Git' },
    ...
    <section className="c-space my-20" id="about">
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="xl:col-span-1 xl:row-span-2">
          <div className="grid-container">
            <img src="assets/grid4.png" alt="" className="w-full xl:h-[225px] md:h-[126px] sm:h-[276px] object-cover sm:object-top" />
              ...
              {[...Array(2)].map((_, setIndex) => (
                <React.Fragment key={setIndex}>
                  {marqueeLogos.map((logo, index) => (
                    <div key={`${setIndex}-${index}`} className="flex-shrink-0 mx-12 md:mx-16 lg:mx-20 group">
                      <img
                        src={logo.src}
                        alt={logo.alt}
                        className="h-10 md:h-12 lg:h-14 w-auto object-contain logo-marquee-item group-hover:opacity-100 transition-all duration-300"
                      />
                    </div>
                  ))}
                </React.Fragment>
